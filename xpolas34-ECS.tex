...
\abstract[en]{The goal of this bachelor thesis is the design and implementation of a library for entity management, which allows software design using \emph{Entity-Component-System} paradigm. Analysis of the current state of software design is presented, including comparison of techniques used for entity representation. Potential advantages are discussed from the hardware point of view, primarily using the memory hierarchy found in modern computers. \\
...
The result of this bachelor thesis is multi-platform library, called \emph{Entropy}, which enables the users to design applications using \emph{ECS} paradigm.}

%Klicova slova (cesky, slovensky ci anglicky) / Keywords (in czech, slovak or english)
\keywords[cs]{Komponentní systém, Entitní systém, ECS, Kompozice, Data-oriented design, Paralelismus, C++}
\keywords[en]{Component system, Entity-component system, Entity-component-system, ECS, Composition, Data-oriented design, Parallelism, C++}
