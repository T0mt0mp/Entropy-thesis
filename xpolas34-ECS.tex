...
Výsledkem této bakalářské práce je multiplatformní knihovna v programovacím jazyce \emph{C++}, pojmenovaná \emph{Entropy}, která vývojářům zpřístupňuje návrh aplikací pomocí \emph{ECS} paradigmatu.}
