...
Práce navrhuje komponentní systém pro jazyk C++, který je možno začlenit do existujících projektů. Vytvořené řešení umožňuje dynamickou kompozici entit za běhu aplikace z komponent definovaných za jejího překladu. Systém je navržen s ohledem na snadnou paralelizaci .Navržený systém je možné začlenit do již existujících projektů, umožňuje paralelní přístup a je uživatelsky rozšiřitelný. \\
