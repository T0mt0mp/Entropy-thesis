...
Tato kapitola obsahuje vyhodnocení výsledné implementace knihovny \uv{Entropy} a její porovnání vůči ostatním, volně dostupným knihovnám. Mezi testované scénáře patří přidání určitého počtu entit a srovnání jakým způsobem se mění čas na přidání jedné entity. 
