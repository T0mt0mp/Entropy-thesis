...
\emph{Systém} lze redukovat na vstupní množinu entit a akci, kterou na nich provádí. Entity jsou specifikovány pomocí množiny komponent (aspektů), které musejí obsahovat. Na této základní definici dále staví návrh tohoto entitního systému a rozšiřuje ho o další funkcionalitu. 
